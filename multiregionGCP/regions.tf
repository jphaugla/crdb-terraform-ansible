...
module "crdb-region-0" {
  ...
  gcp_region_list            = var.gcp_region_list

  # ──────────────────────────────────────────────────────────────────────────
  # ANSIBLE / INVENTORY PATH OVERRIDES
  # ──────────────────────────────────────────────────────────────────────────

  instances_inventory_file           = "../../terraform-gcp/inventory-${var.gcp_region_list[0]}"
  playbook_working_directory         = "../../ansible"
  playbook_instances_inventory_file  = "../terraform-gcp/inventory-${var.gcp_region_list[0]}"
...
module "crdb-region-1" {
  ...
  instances_inventory_file           = "../../terraform-gcp/inventory-${var.gcp_region_list[1]}"
  playbook_working_directory         = "../../ansible"
  playbook_instances_inventory_file  = "../terraform-gcp/inventory-${var.gcp_region_list[1]}"
  instances_inventory_directory      = "temp"
  inventory_template_file            = "templates/inventory.tpl"
...
module "crdb-region-2" {
  ...
  instances_inventory_file           = "../../terraform-gcp/inventory-${var.gcp_region_list[2]}"
  playbook_working_directory         = "../../ansible"
  playbook_instances_inventory_file  = "../terraform-gcp/inventory-${var.gcp_region_list[2]}"
  instances_inventory_directory      = "temp"
  inventory_template_file            = "templates/inventory.tpl"
